...
describe('My First Test', function() {
    beforeEach(function(){
     ...
     /* it('Checks with the Buisness contact page',function(){
         ...
         cy.get('#app > div > div > div > div > div > main > div > article > div > div > div > form > div:nth-child(5) > div > button.\.skip-button.mr-0.v-btn.v-btn--large.theme--light.secondary').click()
      })*/

  
      it('checks with the MVP DASHBOARD',function(){
         // cy.get('#app > div > div > main > div.entity-info > div').conatins( )
      cy.get('#dashboardArticle > div > div > section:nth-child(1) > div > ul > li > div.v-expansion-panel__header > div.list-item > div.list-item__actions > button > div').click()   
      })
    

    it('checks with the AR page',function(){
    ...
    it('checks with the DIRECTOR',function(){
    ...
    it('checks with the Cease of Directors',function(){
    ...
    //it('checks with the pdf downloads',function(){
       ...
       // cy.get('#dashboardArticle > div > div > section:nth-child(2) > div > ul > li.v-expansion-panel__container.filing-history-list.v-expansion-panel__container--active > div.v-expansion-panel__body > div > button > div').click()
        it('checks  with the certification page',function(){
       ...
       it('Checks with the CANCEL button',function(){
